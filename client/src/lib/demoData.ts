...
export const demoProperties: Property[] = [
  {
    ...
    description:
      "Verified luxury home in a secure community near schools, parks, mosque, and commercial access.",
    amenities: ["CCTV", "Parking", "Backup power", "Parks nearby"],
    nearby: ["Bahria Hospital", "Ring Road", "Food Court"],
    agent: {
      name: "Awais Zaheer",
      phone: "+92 321 1112508",
      whatsapp: "+923211112508",
  ...
  },
  {
    ...
    description:
      "High-demand office space on Karachi’s commercial corridor with strong rental potential.",
    amenities: ["Elevator", "Security", "Reception", "Backup power"],
    nearby: ["Main road", "Banks", "Restaurants"],
    agent: {
      name: "Faraz Ahmed",
      phone: "+92 333 1524862",
      whatsapp: "+923331524862",
      agency: "NIKZN Real Estate & Developers",
    },
  },
  {
    ...
    description:
      "Tourism-led investment apartment with installment plan and managed rental potential.",
    amenities: [
      "Mountain view",
      "Installment plan",
      "Rental management",
    ...
    agent: {
      ...
      phone: "+92 300 7444006",
      whatsapp: "+923007444006",
      agency: "NIKZN Real Estate & Developers",
    },
  },
];
